...
export async function mockDepositController(wallet: Wallet, setDepositController: (address: string) => Promise<ContractTransaction>, { onDeposit, depositLimit, onMint, mintLimit }: MockDepositControllerConfig) {
