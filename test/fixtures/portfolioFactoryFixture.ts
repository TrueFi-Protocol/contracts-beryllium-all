import { FlexiblePortfolio__factory, MockUsdc__factory, ProtocolConfig__factory } from 'contracts'
import { Wallet } from 'ethers'
import { deployBehindProxy } from 'utils/deployBehindProxy'
import { FlexiblePortfolioFactory__factory } from 'build/types'
import { protocolFeeRate } from 'config'

export async function portfolioFactoryFixture([protocolOwner, manager]: Wallet[]) {
  ...
  return { factory, protocolOwner, manager, token, portfolioImplementation, protocolConfig, DEFAULT_ADMIN_ROLE, MANAGER_ROLE, PAUSER_ROLE }
}
