...
describe('AutomatedLineOfCreditFactory.createPortfolio', () => {
  ...
  it('only manager can create portfolio', async () => {
    const { other, MANAGER_ROLE, attemptCreatingPortfolio } = await loadFixture(automatedLineOfCreditFactoryFixture)
  ...
  it('reverts after manager role revoked from caller', async () => {
    const { factory, MANAGER_ROLE, protocolOwner, attemptCreatingPortfolio } = await loadFixture(automatedLineOfCreditFactoryFixture)
    ...
    await expect(anotherTx)
      .to.be.revertedWith(accessControlMissingRoleRevertMessage(protocolOwner, MANAGER_ROLE))
  })

  it('sets manager and borrower', async () => {
    const { wallet, createPortfolio } = await loadFixture(automatedLineOfCreditFactoryFixture)
  ...
  it('sets asset', async () => {
    const { token, createPortfolio } = await loadFixture(automatedLineOfCreditFactoryFixture)
  ...
  it('sets endDate', async () => {
    const { createPortfolio, extractCreationTimestamp } = await loadFixture(automatedLineOfCreditFactoryFixture)
  ...
  it('sets name and symbol', async () => {
    const { createPortfolio } = await loadFixture(automatedLineOfCreditFactoryFixture)
    const { portfolio } = await createPortfolio()
  ...
  it('sets depositController', async () => {
    const { createPortfolio, depositControllerImplementation } = await loadFixture(automatedLineOfCreditFactoryFixture)
    const { portfolio } = await createPortfolio()
  ...
  it('sets withdrawController', async () => {
    const { createPortfolio, withdrawControllerImplementation } = await loadFixture(automatedLineOfCreditFactoryFixture)
    const { portfolio } = await createPortfolio()
  ...
  it('sets transferController', async () => {
    const { createPortfolio, transferControllerImplementation } = await loadFixture(automatedLineOfCreditFactoryFixture)
    const { portfolio } = await createPortfolio()
